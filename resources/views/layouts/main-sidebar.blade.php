                ...
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        ...
                        <ul id="dashboard" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('categories.index')}}">{{trans('main-sidebar.categories')}}</a> </li>
                            <li> <a href="{{route('products.index')}}">{{trans('main-sidebar.products')}}</a> </li>
                            <li> <a href="#">test</a> </li>
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#calendar-menu">
                            <div class="pull-left"><i class="ti-calendar"></i><span
                                    class="right-nav-text">Invoices</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="calendar-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('invoices.create')}}">Invoices menu </a> </li>
                            <li> <a href="{{route('invoices.index')}}"> Add new invoice</a> </li>
                        </ul>
                    </li>
                    <!-- menu title -->
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#elements">
                            <div class="pull-left"><i class="ti-palette"></i><span
                                    class="right-nav-text">{{trans('main-sidebar.Elements')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
