...
<div class="content-wrapper">
    <div class="page-title">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="mb-0"> @yield('dashboard')</h4>
            </div>
            <div class="col-sm-6">
                <h5 class="mb-3"> Dashboard / home</h5>
            </div>
            <div class="col-sm-6">
                ...
                <div class="card-body">
                    <div class="clearfix">
                        ...
                        <div class="float-right text-right">
                            ...
                            <h4>{{$count = DB::table('categories')->count()}}</h4>
                        </div>
                    </div>
                    ...
                    <div class="clearfix">
                        ...
                        <div class="float-right text-right">
                            <p class="card-text text-dark">Products</p>
                                <h4>{{$count = DB::table('products')->count()}}</h4>
                        </div>
                    </div>
                    <p class="text-muted pt-3 mb-0 mt-2 border-top">
                ...
                <div class="card-body">
                    <div class="clearfix">
                        ...
                        <div class="float-right text-right">
                            ...
                            <h4>{{$count = DB::table('invoices')->count()}}</h4>
                        </div>
                    </div>
                    <p class="text-muted pt-3 mb-0 mt-2 border-top">
                        <i class="fa fa-calendar mr-1" aria-hidden="true"></i> Sales Per Week
