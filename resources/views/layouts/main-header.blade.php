            ...
            <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown mr-30">
                    <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button"
                        ...
                        <img src="{{URL::asset('assets/images/logo-dark.png')}}" alt="avatar">
                    </a>
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        {{-- <a class="dropdown-item" ><i class="text-info ti-settings"></i><form  action ="{{ \LaravelLocalization::localizeURL('/logout/admin') }}" method="POST">
                        <button>logout</button>
                        @csrf
                       </form> --}}
                       <a class="dropdown-item" ><i class="text-info ti-settings"></i><form  action ="{{ route('logout') }}" method="POST">
