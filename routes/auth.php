...
Route::middleware('guest')->group(function () {
  ...
  // login superAdmin
    Route::get('login/super_admin', [SuperAdminController::class, 'create'])
    ...
    Route::post('login/super_admin', [SuperAdminController::class, 'store']);
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('logout/admin', [AdminController::class, 'destroy'])->name('logout.admin');
      //  super admin
    Route::post('logout/super_admin', [SuperAdminController::class, 'destroy'])->name('logout.super_admin');
